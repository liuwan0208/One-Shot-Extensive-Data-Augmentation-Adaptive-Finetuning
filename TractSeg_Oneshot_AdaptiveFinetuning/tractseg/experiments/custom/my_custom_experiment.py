...
# from tractseg.experiments.tract_seg_lowres import Config as TractSegConfig
...
class Config(TractSegConfig):
    ...
    # filename of nifti file (*.nii.gz) without file ending; mrtrix CSD peaks; shape: [x,y,z,9]; one file for each subject
