...
def load_training_data(Config, subject):
    ...
    #     data = np.concatenate((peaks, t1), axis=3)
        ...
        path = join(Config.DATA_PATH, Config.DATASET_FOLDER, subject, Config.FEATURES_FILENAME)
    ...
    if "|" in Config.LABELS_FILENAME:
        ...
        path = join(Config.DATA_PATH, Config.DATASET_FOLDER, subject, Config.LABELS_FILENAME)
