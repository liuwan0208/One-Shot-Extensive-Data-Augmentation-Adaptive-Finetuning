...
def get_seg_single_img_3_directions(select_path, Config, model, subject=None, data=None, scale_to_world_shape=True,
    ...
    for idx, direction in enumerate(directions):
        ...
        img_probs, img_y = trainer.predict_img(select_path,direction,Config, model, dataManagerSingle, probs=True,
