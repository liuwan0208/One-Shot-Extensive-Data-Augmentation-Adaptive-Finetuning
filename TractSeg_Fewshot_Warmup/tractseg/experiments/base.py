...
class Config:
    ...
    DATA_PATH = '/data/HCP_2.5mm_341k/HCP_daug/Oneshot_683256_4/CutoutYKeep'
    ...
    WEIGHTS_PATH = "/data/TractSeg_Run/hcp_exp6/my_custom_experiment_x30/best_weights_ep188.npz"
